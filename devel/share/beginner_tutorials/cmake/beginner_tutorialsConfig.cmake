...
if("TRUE" STREQUAL "TRUE")
  set(beginner_tutorials_SOURCE_PREFIX /home/vboxuser/-brita--met0310_av-/src/beginner_tutorials)
  set(beginner_tutorials_DEVEL_PREFIX /home/vboxuser/-brita--met0310_av-/devel)
  ...
  set(beginner_tutorials_INSTALL_PREFIX /home/vboxuser/-brita--met0310_av-/install)
...
if(NOT "/home/vboxuser/-brita--met0310_av-/devel/include " STREQUAL " ")
  set(beginner_tutorials_INCLUDE_DIRS "")
  set(_include_dirs "/home/vboxuser/-brita--met0310_av-/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://wiki.ros.org/beginner_tutorials " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Brita Vane <brvane@ttu.ee>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vboxuser/-brita--met0310_av-/src/beginner_tutorials/${idir}'.  ${_report}")
    endif()
